package com.sundy.lingbao.core.tracer;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import com.sundy.lingbao.core.tracer.impl.NullMessageProducerManager;
...
public abstract class Tracer {
	...
	private static MessageProducer getProducer() {
	    ...
	    return producerManager.getMessageProducer();
	}
	...
	public static void logEvent(String type, String name, String status, String nameValuePairs) {
	    try {
	    	...
	    	logger.warn("Failed to log event for type: {}, name: {}, status: {}, nameValuePairs: {}", type, name, status, nameValuePairs, ex);
	    }
	}
	...
	public static Transaction newTransaction(String type, String name) {
	    try {
	    	...
	    	logger.warn("Failed to create transaction for type: {}, name: {}", type, name, ex);
	      	return NULL_MESSAGE_PRODUCER_MANAGER.getMessageProducer().newTransaction(type, name);
	    }
	}
